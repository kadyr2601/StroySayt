    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          <rect width="100%" height="100%" fill="url(#blueprint-grid-cta)" />
        </svg>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <div className="inline-block mb-6">
            ...
            <span className="text-blue-400 text-sm font-medium">Заинтересовал проект?</span>
          </div>
          ...
          <p className="text-lg text-blue-100 mb-8 max-w-3xl mx-auto">
            Свяжитесь с нами, чтобы обсудить ваши идеи и узнать, как мы можем помочь воплотить их в жизнь. Наша команда
            экспертов готова предложить инновационные архитектурные решения для вашего проекта.
          </p>
